...
CREATE TABLE novels ( id VARCHAR(36) NOT NULL, user_id VARCHAR(36), title VARCHAR(512) NOT NULL, intro TEXT NOT NULL, background TEXT NOT NULL, style VARCHAR(255) NOT NULL, target_chapters INTEGER NOT NULL, target_word_count INTEGER NOT NULL, daily_auto_chapters INTEGER NOT NULL, daily_auto_time VARCHAR(16) NOT NULL, last_auto_date VARCHAR(10) NOT NULL, reference_storage_key VARCHAR(1024) NOT NULL, reference_public_url VARCHAR(2048) NOT NULL, reference_filename VARCHAR(512) NOT NULL, framework_json TEXT NOT NULL, framework_markdown TEXT NOT NULL, framework_confirmed BOOL NOT NULL, status VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id), FOREIGN KEY(user_id) REFERENCES users (id) );
...
CREATE TABLE novel_memory_norm_relations ( id VARCHAR(36) NOT NULL, novel_id VARCHAR(36) NOT NULL, memory_version INTEGER NOT NULL, sort_order INTEGER NOT NULL, src VARCHAR(512) NOT NULL, dst VARCHAR(512) NOT NULL, relation TEXT NOT NULL, PRIMARY KEY (id), FOREIGN KEY(novel_id) REFERENCES novels (id) ON DELETE CASCADE );
